---
layout: post
title: Julia Programming Assistant Prompt
gh-repo: David-Manning/David-Manning.github.io
gh-badge: [star, fork, follow]
tags: [julia, prompt-library, assistant, programming, llm]
comments: true
mathjax: true
author: David Manning
---

This prompt will write Julia code given a specific request, which goes at the bottom.
