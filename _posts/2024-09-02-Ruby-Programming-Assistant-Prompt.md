---
layout: post
title: Ruby Programming Assistant Prompt
gh-repo: David-Manning/David-Manning.github.io
gh-badge: [star, fork, follow]
tags: [ruby, prompt-library, assistant, programming, llm]
comments: true
mathjax: true
author: David Manning
---

This prompt will write ruby code given a specific request, which goes at the bottom.
The output will not explain anything or comment and is best used for small pieces of code, maybe a few lines long.
If it matters, you should specify your gems and OS underneath.
